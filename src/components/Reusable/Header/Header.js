...
const Header = ({ home }) => {
    ...
    return (
        <div className="">
            ...
            <nav class={home ? "navbar navbar-expand-lg navbar-light py-3" : "navbar navbar-expand-lg navbar-light py-3 bg-light"}>
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse ms-5" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0 headerMenu">
                            ...
                            <li class="nav-item dropdown me-3">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <hr />
                                    <li><a class="dropdown-item" href="/men/shirt">Shirt</a></li>
                                    <li><a class="dropdown-item" href="/men/t-shirt">T-Shirt</a></li>
                                    <li><a class="dropdown-item" href="/men/trousers">Trousers</a></li>
                                    <li><a class="dropdown-item" href="/men/jackets">Jackets</a></li>
                                    <li><a class="dropdown-item" href="/men/shorts">Shorts</a></li>
                                    <li><a class="dropdown-item" href="/men/pants">Pants</a></li>
                                </ul>
                            </li>
                            <li class="nav-item dropdown me-3">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <hr />
                                    <li><a class="dropdown-item" href="/women/shirt">Shirt</a></li>
                                    <li><a class="dropdown-item" href="/women/t-shirt">T-Shirt</a></li>
                                    <li><a class="dropdown-item" href="/men/pants">Pants</a></li>
                                    <li><a class="dropdown-item" href="/women/jackets">Jackets</a></li>
                                    <li><a class="dropdown-item" href="/women/bags">Bags</a></li>
                                </ul>
                            </li>
                        </ul>
                        ...
                        <div className="ms-5">
                            <Link className={path?.pathname === "/cart" ? "me-4 active": "me-4"} to="/cart">
